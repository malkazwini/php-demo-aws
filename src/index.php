...
<head>
    ...
    <title>Pipeline Demo Meeting 2017</title>
    ...
    <div class="content-wrapper">
        <div class="v-center">
            <div class="main-content">
                <p>Thanks for attending our meeting 2017 Your PHP application is now running on the host &ldquo;<?php echo gethostname(); ?>&rdquo; in your own dedicated environment in the AWS&nbsp;CodePipeline on ECS. This Docker container is running PHP version <?php echo phpversion(); ?>.</p>
                <ul>
                    <li><a href="http://twitter.com/">Twitter</a></li>
                    <li><a href="http://facebook.com/">Facebook</a></li>
                    <li><a href="https://dribbble.com/">Dribbble</a></li>
                    <li><a href="mailto:kalkazwini@deloitte.ca">Contact</a></li>
                </ul>
            </div>
        </div>
    </div>
