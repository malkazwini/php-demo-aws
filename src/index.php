...
<head>
    ...
    <title>Pipeline Demo Agile 2017</title>
    ...
    <div class="content-wrapper">
        <div class="v-center">
            <div class="main-content">
                <p>Thanks for attending Agile 2017 Your PHP application is now running on the host &ldquo;<?php echo gethostname(); ?>&rdquo; in your own dedicated environment in the AWS&nbsp;CodePipeline on ECS. This Docker container is running PHP version <?php echo phpversion(); ?>.</p>
                <ul>
